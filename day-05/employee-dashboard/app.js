/**
 * Mock REST API for the Employee Dashboard.
 * No backend exists yet (that's Day 7), so this simulates GET/POST/PUT/DELETE
 * over an in-memory dataset with artificial network delay, so the UI layer
 * can be written exactly as if it were calling a real API.
 */
